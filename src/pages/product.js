                        ...
                        <div className="col-md-3 order-1 mb-5 mb-md-0">
                            <div className="border p-4 rounded mb-4">
                                ...
                                <ul className="list-unstyled mb-0">
                                    ...
                                    <li className="mb-1"><a href="#" className="d-flex"><span>nike</span> <span className="text-black ml-auto">(2,124)</span></a></li>
                                    <li className="mb-1"><a href="#" className="d-flex"><span>adidas</span> <span className="text-black ml-auto">(2,124)</span></a></li>
                                </ul>
                            </div>
                            <div className="border p-4 rounded mb-4">
                                <div className="mb-4">
